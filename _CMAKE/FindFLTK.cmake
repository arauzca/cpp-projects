...
message( "FLTK using MAC libs" )
  ...
  set( FLTK_LIBRARY_DEBUG "${FLTK_LIBRARIES_PATH}/libfltk.a" )
  set( FLTK_GL_LIBRARY_DEBUG "${FLTK_LIBRARIES_PATH}/libfltk_gl.a" )
endif()
...
if( FLTK_FOUND )
  ...
  message( "FLTK library was not found!" )
endif( FLTK_FOUND )
